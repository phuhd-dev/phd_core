...
class BlocProvider<T> extends InheritedWidget {
  ...
  static T of<T>(BuildContext context, {bool listen = true}) {
    final BlocProvider<T> provider = listen
        ...
        : context.getElementForInheritedWidgetOfExactType<BlocProvider<T>>()?.widget;
    if (provider == null) {
...
class MultiBlocProvider extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      providers.reversed.fold(child, (Widget widget, BlocProvider<dynamic> provider) => provider.copyWith(widget));
}
